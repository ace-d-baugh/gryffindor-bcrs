...
export class UserListComponent implements OnInit {
  ...
  constructor(private userService: UserService, private confirmationService: ConfirmationService, private fb: FormBuilder, private messageService: MessageService)
  {
    this.users = [];
    this.errorMessages = [];
